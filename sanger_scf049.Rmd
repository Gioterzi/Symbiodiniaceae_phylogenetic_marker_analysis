...
f_all_fasta_sub <- f_all_fasta %>%
  mutate(sequence = case_when(str_detect(label, "49-1_Cob") ~ str_sub(sequence, start = 30, end = 930),
                              str_detect(label, "55-1_Cob") ~ str_sub(sequence, start = 30, end = 930),
                              ...
                              str_detect(label, "55-1_cp23S") ~ str_sub(sequence, start = 30, end = 570),
...
r_all_fasta_sub <- r_all_fasta %>%
  mutate(sequence = case_when(str_detect(label, "49-1_Cob") ~ str_sub(sequence, start = 30, end = 910),
                              str_detect(label, "55-1_Cob") ~ str_sub(sequence, start = 30, end = 910),
...
sequence_names <- c("SCF049-1-Cob", "SCF049-2-Cob", "SCF049-3-Cob","SCF055-1-Cob", "SCF049-1-Cox1", "SCF049-2-Cox1", "SCF049-3-Cox1","SCF055-1-Cox1", "SCF055-4-Cox1", "SCF055-5-Cox1", "SCF049-1-cp23s", "SCF049-2-cp23s", "SCF049-3-cp23s","SCF055-1-cp23s","SCF049-1-LSU", "SCF049-2-LSU", "SCF049-3-LSU","SCF055-1-LSU", "SCF055-4-LSU", "SCF055-5-LSU", "diosanto")
...
trimmed_consensus <- subseq(consensus, start = 870, end = 1050) #trim to the matching region only
writeXStringSet(trimmed_consensus, "consensus_psbA_049.fasta")

align_list_final2 <- align_psba_R[4] #removal SCF055 sequence
names(align_list_final2) <- "SCF055-1-psbA"
trimmed_consensus2 <- subseq(align_list_final2, start = 870, end = 1050) #trim to the matching region only
